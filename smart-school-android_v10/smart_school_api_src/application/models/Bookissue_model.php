...
class Bookissue_model extends CI_Model
{
    ...
    {
        $this->db->select('book_issues.return_date,books.book_no,book_issues.issue_date,book_issues.is_returned,books.book_title,books.author,books.book_no,books.subject')
            ->from('book_issues')
