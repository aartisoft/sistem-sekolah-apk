...
import com.qdocs.smartschool.adapters.StudentReportCard_ExamListAdapter;
...
public class StudentDashboardReportCard extends Fragment {
    ...
    private void loadData() {
        ...
        adapter = new StudentReportCard_ExamListAdapter(getActivity().getApplicationContext(),examIdList, examNameList, totalList, percentList, gradeList, statusList);
    ...
    private void getDataFromApi (String bodyParams) {
        ...
        String url = Utility.getSharedPreferences(getActivity().getApplicationContext(), "apiUrl")+Constants.getExamResultListUrl;
