...
import com.qdocs.smartschool.students.StudentReportCard_ExamResult;
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        holder.viewContainer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent asd = new Intent(context.getApplicationContext(), StudentReportCard_ExamResult.class);
                asd.putExtra("examId", examIdList.get(position));
                asd.putExtra("examName", examNameList.get(position));
                asd.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
