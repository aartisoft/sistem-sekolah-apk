...
//                Utility.setSharedPreference(getApplicationContext(), Constants.apiUrl, "https://qdocs.in/ssapi/");
//                Utility.setSharedPreference(getApplicationContext(), Constants.imagesUrl, "https://qdocs.in/ssapi/");//object.getString("system_url"));
...
//                Utility.setSharedPreference(getApplicationContext(), Constants.primaryColour, "#E91E63");
//                Utility.setSharedPreference(getApplicationContext(), Constants.secondaryColour, "#00BCD4");
...
//                startActivity(asd);
    ...
    public void setLocale(String localeName) {
     ...
     private void getDataFromApi (String domain) {
         ...
         RequestQueue requestQueue = Volley.newRequestQueue(TakeUrl.this);
