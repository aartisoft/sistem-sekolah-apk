...
public class StudentExamSchedule extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        params.put("examId", getIntent().getStringExtra("examId"));
        JSONObject obj=new JSONObject(params);
        Log.e("params ", obj.toString());

        getDataFromApi(obj.toString());

        adapter = new StudentExamScheduleAdapter(StudentExamSchedule.this,subjectList, dateList, timeList, roomList);
                    ...
                    try {
                        ...
                        if (success.equals("1")) {
                            ...
                            for(int i=0; i<dataArray.length(); i++) {
                                ...
                                dateList.add(Utility.parseDate("yyyy-MM-dd", defaultDateFormat, dataObject.getString("date_of_exam")));
                                timeList.add(dataObject.getString("start_to") + " / " + dataObject.getString("end_from"));
