...
public class StudentHomeworkAdapter extends RecyclerView.Adapter<StudentHomeworkAdapter.MyViewHolder> {
    ...
    public StudentHomeworkAdapter(FragmentActivity studentHomework, ArrayList<String> homeworkIdList, ArrayList<String> homeworkTitleList,
                                  ArrayList<String> homeworkSubjectNameList, ArrayList<String> homeworkHomeworkDateList, ArrayList<String> homeworkSubmissionDateList,
                                  ArrayList<String> homeworkEvaluationDateList, ArrayList<String> homeworkEvaluationByList, ArrayList<String> homeworkCreatedByList,
                                  ArrayList<String> homeworkDocumentList, ArrayList<String> homeworkClasssList,
                                  ArrayList<String> homeworkStatusList) {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        holder.statusTV.setText(homeworkStatusList.get(position));
        ...
        if(homeworkEvaluationByList.get(position).equals("null")) {
            ...
            //STATUS
            if(homeworkStatusList.get(position).equals("Complete")) {
                holder.statusTV.setVisibility(View.VISIBLE);
                holder.statusTV.setBackgroundResource(R.drawable.green_border);
            } else if (homeworkStatusList.get(position).equals("Incomplete")) {
                holder.statusTV.setVisibility(View.VISIBLE);
