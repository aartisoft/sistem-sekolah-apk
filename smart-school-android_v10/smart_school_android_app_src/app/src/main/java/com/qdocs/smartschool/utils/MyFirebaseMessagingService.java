    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        if (remoteMessage != null)
        {
            ...
            try {
                switch (action) {
                    case "fees" :
                        intent = new Intent(this, com.qdocs.smartschool.students.StudentFees.class);
                        break;

                    case "absent" :
                        intent = new Intent(this, com.qdocs.smartschool.students.StudentAttendance.class);
                        break;

                    case "exam" :
                        intent = new Intent(this, com.qdocs.smartschool.students.StudentReportCard_ExamList.class);
                        break;

                    default:
                        intent = new Intent(this, com.qdocs.smartschool.students.StudentDashboard.class);
                        break;
                }
