...
public class StudentFeesAdapter extends RecyclerView.Adapter<StudentFeesAdapter.MyViewHolder> {
    ...
    public StudentFeesAdapter(FragmentActivity activity, ArrayList<String> feesIdList, ArrayList<String> feesCodeList,
                              ...
                              ArrayList<String> discountStatusList) {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        private TextView feesCodeTV, feesDueDateTV, feesAmtTV, feesPaidAmtTV, feesDueAmtTV, feesStatusTV, payBtn;
        ...
        public MyViewHolder(View rowView) {
            ...
            discountNameTV = rowView.findViewById(R.id.studentFeesAdapter_discountNameTV);
    ...
    private void showDiscountCard(MyViewHolder viewHolder, final int position) {
        ...
        viewHolder.feesCodeTV.setText(studentsFees.getString(R.string.paymentDiscount));
        ...
        discountMsg += discountAmtList.get(position) + " " + discountStatusList.get(position);
