...
public class StudentDashboardHomeWork extends Fragment {
    ...
    private void loadData() {
        ...
        adapter = new StudentHomeworkAdapter(getActivity(), homeworkIdList,
                homeworkTitleList, homeworkSubjectNameList, homeworkHomeworkDateList,
                homeworkSubmissionDateList, homeworkEvaluationDateList, homeworkEvaluationByList,
                    ...
                    try {
                        ...
                        if(dataArray.length() != 0) {
                            ...
                            for(int i = 0; i < dataArray.length(); i++) {
                                ...
                                //Utility.parseDate("yyyy-MM-dd", defaultDateFormat, dataArray.getJSONObject(i).getString("evaluation_date")));
                                ...
                                try {
                                    JSONObject evaluationData = dataArray.getJSONObject(i).getJSONObject("report");

                                    homeworkEvaluationDateList.add( Utility.parseDate("yyyy-MM-dd", defaultDateFormat, evaluationData.getString("date")));
                                    homeworkStatusList.add(evaluationData.getString("status"));
                                } catch (JSONException je) {
                                    homeworkEvaluationDateList.add("");
                                    homeworkStatusList.add("Not-Evaluated");
                                }
