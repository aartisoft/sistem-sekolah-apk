...
public class StudentLibraryBookIssued extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new StudentLibraryBookIssuedAdapter(StudentLibraryBookIssued.this,
                bookNameList, authorNameList, bookNoList, issueDateList, returnDateList, statusList);
    ...
    private void getDataFromApi (String bodyParams) {
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(StudentLibraryBookIssued.this);
