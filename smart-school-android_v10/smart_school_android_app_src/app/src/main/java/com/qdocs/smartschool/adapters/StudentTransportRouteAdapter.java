...
public class StudentTransportRouteAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View view, ViewGroup viewGroup) {
        ...
        if (rowView == null) {
            ...
            rowView = inflater.inflate(R.layout.adapter_student_transport, viewGroup, false);
            viewHolder = new ViewHolder();


            viewHolder.nameHeader = rowView.findViewById(R.id.studentTransportAdapter_nameHeader);
            viewHolder.vehicleTable = rowView.findViewById(R.id.studentTransportAdapter_vehicleTable);

            viewHolder.routeNameTV = (TextView) rowView.findViewById(R.id.studentTransportAdapter_routeNameTV);
        ...
        try {
            ...
            for(int i=0; i<dataArray.length(); i++) {
                ...
                // Draw separator
    //            tv = new TextView(StudentExamSchedule.this);
    //            tv.setBackgroundColor(Color.parseColor("#80808080"));
    //            tv.setHeight(1);
    //            scheduleTable.addView(tv);
